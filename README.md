...
# new application using angular

- ng new death-star --skip-npm --skip-git --directory death-star --source-dir my-source --style less --prefix px --routing false --inline-template
tworzy to nową lokalizację death-star (--directory)
